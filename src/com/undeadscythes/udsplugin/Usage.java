...
public enum Usage {
    ...
    PASSWORD(Perm.PASSWORD, "/password", "Show your UDS Minecraft password."),
    ...
    ADMIN_MOD_CI(Perm.CI_OTHER, "/ci <player>", "Clear another players inventory.", ADMIN),
    ...
    MOD_CI(Perm.CI_OTHER, "/ci <player>", "Clear another players inventory.", MOD),
    ...
    VIP(Perm.VIP_RANK, "/vip help", "Show more vip commands.", true),
    VIP_I(Perm.I, "/i <item>[:data] [amount]", "Spawn an item.", VIP),
    VIP_SPAWNS(Perm.VIP_RANK, "/vip", "Check the number of daily spawns you have left.", VIP),
    VIP_ITEMS(Perm.VIP_RANK, "/vip spawns", "Check which items are whitelisted.", VIP),
    ...
    PVP(Perm.PVP, "/pvp", "Enable PvP, must remain in PvP for 5 minutes."),
