    ...
    public void playerExecute() {
        ...
        if(args.length == 1) {
            if(subCmd.equals("set")) {
                if((city = getRegion()).getType() == RegionType.CITY && ownsCity(city.getName()) != null) {
            ...
            if(subCmd.equals("invite")) {
                if((city = ownsCity(args[1])) != null && (target = matchesPlayer(args[2])) != null) {
