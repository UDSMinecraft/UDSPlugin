...
public class HelpCmd extends CommandWrapper {
    private enum Usage {
        ...
        ADMIN(Perm.ADMIN, "/admin help", "Show more admin/mod/warden commands.", true, false),
        ...
        ADMIN_MOD_A(Perm.A, "/a", "Switch to the admin chat channel.", false, true),
        ADMIN_MOD_A_MSG(Perm.A, "/a <message>", "Send a message in the admin chat channel.", false, true),
        ADMIN_MOD_BROADCAST(Perm.BROADCAST, "/b <message>", "Send a server message.", false, true),
        ADMIN_MOD_BAN(Perm.BAN, "/ban <player>", "Ban a player from the server.", false, true),
        ADMIN_MOD_UNBAN(Perm.UNBAN, "/unban <player>", "Unban a player from the server.", false, true),
        ADMIN_MOD_BUTCHER(Perm.BUTCHER, "/butcher", "Kill hostile mobs around you.", false, true),
        ADMIN_MOD_BUTCHER_ALL(Perm.BUTCHER, "/butcher a", "Kill all mobs around you.", false, true),
        ADMIN_MOD_ENCHANT(Perm.ENCHANT, "/enchant <enchantment> [level]", "Enchant an item.", false, true),
        ADMIN_MOD_ENCHANT_LIST(Perm.ENCHANT, "/enchant", "Get a list of available enchantments.", false, true),
        ADMIN_MOD_GOD(Perm.GOD, "/god [player]", "Toggle a players god mode", false, true),
        ADMIN_MOD_HEAL(Perm.HEAL, "/heal [player]", "Heal a player.", false, true),
        ADMIN_MOD_INVSEE(Perm.INVSEE, "/invsee <player>", "Get a copy of a players inventory.", false, true),
        ADMIN_MOD_INVSEE_RESET(Perm.INVSEE, "/invsee", "Get your inventory back.", false, true),
        ADMIN_MOD_KICK(Perm.KICK, "/kick <player> [reason]", "Kick a player from the server.", false, true),
        ADMIN_MOD_NICK_OTHER(Perm.NICK_OTHER, "/nick <player> <nickname>", "Change a players nickname.", false, true),
        ADMIN_MOD_POWERTOOL(Perm.POWERTOOL, "/powertool <command>", "Set a powertool.", false, true),
        ADMIN_MOD_PROMOTE(Perm.PROMOTE, "/promote <player>", "Promote a player.", false, true),
        ADMIN_MOD_DEMOTE(Perm.DEMOTE, "/demote <player>", "Demote a player.", false, true),
        ADMIN_MOD_SIGNS(Perm.SIGNS, "/signs", "View a list of special signs you can make.", false, true),
        ADMIN_MOD_SPAWNER(Perm.SPAWNER, "/spawner <monster>", "Set the mob type of a spawner.", false, true),
        ADMIN_MOD_TGM(Perm.TGM, "/tgm [player]", "Toggle a players game mode.", false, true),
        ADMIN_MOD_TP(Perm.TP, "/tp <player>", "Teleport to another player.", false, true),
        ADMIN_MOD_TP_OTHER(Perm.TP, "/tp <player> <player>", "Teleport one player to another.", false, true),
        ADMIN_MOD_XP(Perm.XP, "/xp <player> <level>", "Give a player experience.", false, true),
        ADMIN_MOD_XP_RESET(Perm.XP, "/xp <player> reset", "Reset a players level.", false, true),
        ADMIN_WARDEN_DAY(Perm.DAY, "/day", "Set the server time to day.", false, true),
        ADMIN_WARDEN_NIGHT(Perm.NIGHT, "/night", "Set the server time to night.", false, true),
        ADMIN_WARDEN_JAIL(Perm.JAIL, "/jail <player> [time] [bail]", "Jail a player.", false, true),
        ADMIN_WARDEN_UNJAIL(Perm.UNJAIL, "/unjail <player>", "Release a player from jail.", false, true),
        ADMIN_WARDEN_SETWARP(Perm.SETWARP, "/setwarp <name> [rank] [price]", "Set a warp point.", false, true),
        ADMIN_WARDEN_DELWARP(Perm.DELWARP, "/delwarp <warp>", "Delete a warp point.", false, true),
        ADMIN_WARDEN_SUN(Perm.SUN, "/sun", "Set the server weather to sunny.", false, true),
        ADMIN_WARDEN_RAIN(Perm.RAIN, "/rain [duration]", "Set the server weather to rainy.", false, true),
        ADMIN_WARDEN_STORM(Perm.STORM, "/storm [duration]", "Set the server weather to stormy.", false, true),
        
        MOD(Perm.MOD_HELP, "/mod help", "Show more mod/warden commands.", true, false),
        ...
        MOD_WARDEN_DAY(Perm.DAY, "/day", "Set the server time to day.", false, true),
        MOD_WARDEN_NIGHT(Perm.NIGHT, "/night", "Set the server time to night.", false, true),
        MOD_WARDEN_JAIL(Perm.JAIL, "/jail <player> [time] [bail]", "Jail a player.", false, true),
        MOD_WARDEN_UNJAIL(Perm.UNJAIL, "/unjail <player>", "Release a player from jail.", false, true),
        MOD_WARDEN_SETWARP(Perm.SETWARP, "/setwarp <name> [rank] [price]", "Set a warp point.", false, true),
        MOD_WARDEN_DELWARP(Perm.DELWARP, "/delwarp <warp>", "Delete a warp point.", false, true),
        MOD_WARDEN_SUN(Perm.SUN, "/sun", "Set the server weather to sunny.", false, true),
        MOD_WARDEN_RAIN(Perm.RAIN, "/rain [duration]", "Set the server weather to rainy.", false, true),
        MOD_WARDEN_STORM(Perm.STORM, "/storm [duration]", "Set the server weather to stormy.", false, true),
        ...
        PORTAL(Perm.PORTAL, "/portal help", "Show more portal commands.", true, false),
        PORTAL_DEST(Perm.PORTAL, "/portal dest <name> <warp>", "Change a portal warp.", false, true),
        PORTAL_LIST(Perm.PORTAL, "/portal list", "List all portals.", false, true),
        PORTAL_SET(Perm.PORTAL, "/portal set <name> [warp]", "Set a new portal.", false, true),
        PORTAL_REMOVE(Perm.PORTAL, "/portal remove <name>", "Remove a portal.", false, true),
        ...
        VANISH(Perm.VANISH, "/vanish help", "Show more vanish commands.", true, false),
        VANISH_SELF(Perm.VANISH, "/vanish", "Make your self vanish or reappear.", false, true),
        VANISH_LIST(Perm.VANISH, "/vanish list", "View a list of vanished players.", false, true),
